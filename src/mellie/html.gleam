...
pub fn progress(attrs, children) {
  mellie.element("progress", attrs, children)
}
...
pub fn kbd(attrs, children) {
  mellie.element("kbd", attrs, children)
}
...
pub fn b(attrs, children) {
  mellie.element("b", attrs, children)
}
...
pub fn sup(attrs, children) {
  mellie.element("sup", attrs, children)
}

/// Creates a grouping of options within a `select` element.
pub fn optgroup(attrs, children) {
  mellie.element("optgroup", attrs, children)
}
...
pub fn mark(attrs, children) {
  mellie.element("mark", attrs, children)
}
...
pub fn var(attrs, children) {
  mellie.element("var", attrs, children)
}

/// Represents a caption for the content of its parent `fieldset` .
pub fn legend(attrs, children) {
  mellie.element("legend", attrs, children)
}

/// Represents a portion of a document whose content is only indirectly related to the document's main content. Asides are frequently presented as sidebars or call-out boxes.
pub fn aside(attrs, children) {
  mellie.element("aside", attrs, children)
}
...
pub fn tr(attrs, children) {
  mellie.element("tr", attrs, children)
}
...
pub fn footer(attrs, children) {
  mellie.element("footer", attrs, children)
}
...
pub fn geolocation(attrs, children) {
  mellie.element("geolocation", attrs, children)
}

/// Represents a part that contains a set of form controls or other content related to performing a search or filtering operation.
pub fn search(attrs, children) {
  mellie.element("search", attrs, children)
}

/// Represents a nested browsing context, like `iframe` but with more native privacy features built in.
pub fn fencedframe(attrs, children) {
  mellie.element("fencedframe", attrs, children)
}

/// Represents an unordered list of items, typically rendered as a bulleted list.
pub fn ul(attrs, children) {
  mellie.element("ul", attrs, children)
}

/// A child of the `tr` element, it defines a cell of a table that contains data.
pub fn td(attrs, children) {
  mellie.element("td", attrs, children)
}
...
pub fn canvas(attrs, children) {
  mellie.element("canvas", attrs, children)
}
...
pub fn wbr(attrs) {
  mellie.element("wbr", attrs, [])
}

/// Embeds external content at the specified point in the document. This content is provided by an external application or other source of interactive content such as a browser plug-in.
pub fn embed(attrs) {
  mellie.element("embed", attrs, [])
}
...
pub fn dfn(attrs, children) {
  mellie.element("dfn", attrs, children)
}

/// Together with its href attribute, creates a hyperlink to web pages, files, email addresses, locations within the current page, or anything else a URL can address.
pub fn a(attrs, children) {
  mellie.element("a", attrs, children)
}
...
pub fn audio(attrs, children) {
  mellie.element("audio", attrs, children)
}
...
pub fn style(attrs, children) {
  mellie.element("style", attrs, children)
}
...
pub fn datalist(attrs, children) {
  mellie.element("datalist", attrs, children)
}

/// Represents an ordered list of items — typically rendered as a numbered list.
pub fn ol(attrs, children) {
  mellie.element("ol", attrs, children)
}
...
pub fn blockquote(attrs, children) {
  mellie.element("blockquote", attrs, children)
}
...
pub fn pre(attrs, children) {
  mellie.element("pre", attrs, children)
}
...
pub fn dl(attrs, children) {
  mellie.element("dl", attrs, children)
}

/// Represent six levels of section headings. `h1` is the highest section level and `h6` is the lowest.
pub fn h3(attrs, children) {
  mellie.element("h3", attrs, children)
}

/// Specifies the base URL to use for all relative URLs in a document. There can be only one such element in a document.
pub fn base(attrs) {
  mellie.element("base", attrs, [])
}

/// Embeds an image into the document.
pub fn img(attrs) {
  mellie.element("img", attrs, [])
}

/// Defines a group of columns within a table.
pub fn colgroup(attrs, children) {
  mellie.element("colgroup", attrs, children)
}
...
pub fn rt(attrs, children) {
  mellie.element("rt", attrs, children)
}

/// Specifies the caption (or title) of a table.
pub fn caption(attrs, children) {
  mellie.element("caption", attrs, children)
}
...
pub fn section(attrs, children) {
  mellie.element("section", attrs, children)
}
...
pub fn picture(attrs, children) {
  mellie.element("picture", attrs, children)
}
...
pub fn div(attrs, children) {
  mellie.element("div", attrs, children)
}
...
pub fn cite(attrs, children) {
  mellie.element("cite", attrs, children)
}

/// Represents a thematic break between paragraph-level elements: for example, a change of scene in a story, or a shift of topic within a section.
pub fn hr(attrs) {
  mellie.element("hr", attrs, [])
}

/// Represent six levels of section headings. `h1` is the highest section level and `h6` is the lowest.
pub fn h4(attrs, children) {
  mellie.element("h4", attrs, children)
}

/// Defines a section of HTML to be inserted if a script type on the page is unsupported or if scripting is currently turned off in the browser.
pub fn noscript(attrs, children) {
  mellie.element("noscript", attrs, children)
}

/// Represent six levels of section headings. `h1` is the highest section level and `h6` is the lowest.
pub fn h6(attrs, children) {
  mellie.element("h6", attrs, children)
}
...
pub fn tbody(attrs, children) {
  mellie.element("tbody", attrs, children)
}
...
pub fn u(attrs, children) {
  mellie.element("u", attrs, children)
}
...
pub fn script(attrs, children) {
  mellie.element("script", attrs, children)
}

/// Represents an external resource, which can be treated as an image, a nested browsing context, or a resource to be handled by a plugin.
pub fn object(attrs, children) {
  mellie.element("object", attrs, children)
}
...
pub fn em(attrs, children) {
  mellie.element("em", attrs, children)
}
...
pub fn s(attrs, children) {
  mellie.element("s", attrs, children)
}

/// Indicates that the enclosed HTML provides contact information for a person or people, or for an organization.
pub fn address(attrs, children) {
  mellie.element("address", attrs, children)
}

/// Contains machine-readable information (metadata) about the document, like its title , scripts , and style sheets .
pub fn head(attrs, children) {
  mellie.element("head", attrs, children)
}
...
pub fn sub(attrs, children) {
  mellie.element("sub", attrs, children)
}
...
pub fn dt(attrs, children) {
  mellie.element("dt", attrs, children)
}

/// Used with `area` elements to define an image map (a clickable link area).
pub fn map(attrs, children) {
  mellie.element("map", attrs, children)
}

/// Represents a caption for an item in a user interface.
pub fn label(attrs, children) {
  mellie.element("label", attrs, children)
}
...
pub fn button(attrs, children) {
  mellie.element("button", attrs, children)
}
...
pub fn track(attrs) {
  mellie.element("track", attrs, [])
}

/// Represents a document section containing interactive controls for submitting information.
pub fn form(attrs, children) {
  mellie.element("form", attrs, children)
}
...
pub fn th(attrs, children) {
  mellie.element("th", attrs, children)
}
...
pub fn ruby(attrs, children) {
  mellie.element("ruby", attrs, children)
}

/// Represents an abbreviation or acronym.
pub fn abbr(attrs, children) {
  mellie.element("abbr", attrs, children)
}
...
pub fn svg(attrs, children) {
  mellie.element("svg", attrs, children)
}
...
pub fn samp(attrs, children) {
  mellie.element("samp", attrs, children)
}

/// Used to group several controls as well as labels ( `label` ) within a web form.
pub fn fieldset(attrs, children) {
  mellie.element("fieldset", attrs, children)
}

/// Overrides the current directionality of text, so that the text within is rendered in a different direction.
pub fn bdo(attrs, children) {
  mellie.element("bdo", attrs, children)
}
...
pub fn small(attrs, children) {
  mellie.element("small", attrs, children)
}
...
pub fn code(attrs, children) {
  mellie.element("code", attrs, children)
}

/// Represents a multi-line plain-text editing control, useful when you want to allow users to enter a sizeable amount of free-form text, for example, a comment on a review or feedback form.
pub fn textarea(attrs, children) {
  mellie.element("textarea", attrs, children)
}
...
pub fn rp(attrs, children) {
  mellie.element("rp", attrs, children)
}
...
pub fn title(attrs, children) {
  mellie.element("title", attrs, children)
}

/// Represents a section of a page whose purpose is to provide navigation links, either within the current document or to other documents. Common examples of navigation sections are menus, tables of contents, and indexes.
pub fn nav(attrs, children) {
  mellie.element("nav", attrs, children)
}
...
pub fn i(attrs, children) {
  mellie.element("i", attrs, children)
}
...
pub fn thead(attrs, children) {
  mellie.element("thead", attrs, children)
}

/// Represent six levels of section headings. `h1` is the highest section level and `h6` is the lowest.
pub fn h5(attrs, children) {
  mellie.element("h5", attrs, children)
}
...
pub fn slot(attrs, children) {
  mellie.element("slot", attrs, children)
}
...
pub fn p(attrs, children) {
  mellie.element("p", attrs, children)
}
...
pub fn option(attrs, children) {
  mellie.element("option", attrs, children)
}

/// Represents a nested browsing context, embedding another HTML page into the current one.
pub fn iframe(attrs, children) {
  mellie.element("iframe", attrs, children)
}

/// A mechanism for holding HTML that is not to be rendered immediately when a page is loaded but may be instantiated subsequently during runtime using JavaScript.
pub fn template(attrs, children) {
  mellie.element("template", attrs, children)
}
...
pub fn details(attrs, children) {
  mellie.element("details", attrs, children)
}
...
pub fn summary(attrs, children) {
  mellie.element("summary", attrs, children)
}
...
pub fn html(attrs, children) {
  mellie.element("html", attrs, children)
}
